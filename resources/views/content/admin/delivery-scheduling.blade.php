                            ...
                            <table class="table datatable-invoice border-top">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        @if($schedule->user_id)
                                        <img src="{{ asset('path/to/your/image.jpg') }}" alt="No Operator Image" class="h-auto rounded-circle">
                                        @else
                                        No operator found 
                                        @endif
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-primary badge" data-bs-toggle="modal" data-bs-target="#addNewCCModal"> Assign </button>
                                        </td>
                                    </tr>
                                    @endforeach
        ...
        <div class="modal-body">
          ...
          <form id="addNewCCForm" class="row g-3">
            ...
            <div class="col-12 text-end">
              ...
              <button type="reset" class="btn btn-label-secondary btn-md btn-reset badge" data-bs-dismiss="modal" aria-label="Close">Cancel</button>
            </div>
          </form>
        </div>
      </div>
